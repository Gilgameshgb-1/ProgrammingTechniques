...
class Administracija{
    std::map<int,std::shared_ptr<Student>> mapastudenata;
    std::map<int,std::shared_ptr<Laptop>> mapalaptopa;
public:
    Administracija(){};
    ~Administracija(){
    };
    void RegistrirajNovogStudenta(int brIndeksa,std::string godSt,std::string ime_i_prezime,std::string adresa,std::string brTel){
        ...
        mapastudenata.insert(std::make_pair(brIndeksa,std::make_shared<Student>(brIndeksa,godSt,ime_i_prezime,adresa,brTel)));
    };
    void RegistrirajNoviLaptop(int Broj,std::string Ime,std::string Karakt){
        ...
        mapalaptopa.insert(std::make_pair(Broj,std::make_shared<Laptop>(Broj,Ime,Karakt)));
    };
